...
export default function SocialBar() {
  return (
    <div className="py-10 px-4" style={{ background: "#1a5276" }}>
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="text-white text-center md:text-left">
          <p className="font-bold text-lg">Theo dõi chúng tôi</p>
          <p className="text-sm opacity-70">Cập nhật món mới, ưu đãi hàng tuần</p>
        </div>
        ...
        <div className="text-center md:text-right text-white">
          <p className="font-bold">📞 0297 123 4567</p>
          <p className="text-sm opacity-70">Hotline đặt bàn</p>
        </div>
      </div>
    </div>
  );
